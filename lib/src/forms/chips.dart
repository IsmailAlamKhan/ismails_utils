...
class IsmailChoiceChipFormField<T> extends IsmailFormField<T> {
  ...
  /// such as [Text].
  ///
  /// If [labelStyle._selectedColor] is a [MaterialStateProperty<Color>], [MaterialStateProperty.resolve]
  ...
  IsmailChoiceChipFormField({
    ...
    this.visualDensity,
            ...
            builder: (FormFieldState<T?> field) {
              final state = field as _IsmailChoiceChipStateFormField<T>;
              ...
              return InputDecorator(
                ...
                child: SingleChildScrollView(
                  child: Wrap(
                    ...
                    children: <Widget>[
                      for (IsmailFormFieldOption<T> option in options)
                        ChoiceChip(
                          label: option,
  ...
  @override
  _IsmailChoiceChipStateFormField<T> createState() =>
      _IsmailChoiceChipStateFormField<T>();
}

class _IsmailChoiceChipStateFormField<T>
    extends IsmailFormFieldState<IsmailChoiceChipFormField<T>, T> {}
